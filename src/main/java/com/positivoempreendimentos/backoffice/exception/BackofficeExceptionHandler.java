package com.positivoempreendimentos.backoffice.exception;
...
@ControllerAdvice
public class BackofficeExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
    ...
    return buildResponseEntity(HttpStatus.BAD_REQUEST, "informed argument(s) validation errors", errors);
  }
